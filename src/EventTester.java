...
public class EventTester {
    ...
    public static void meeting1(){
        ...
        System.out.println(meeting1.getName());
        System.out.println(meeting1.getDuration());
        System.out.println(meeting1.isComplete());
        meeting1.complete();
        System.out.println(meeting1.isComplete());
    }
    public static void meeting2(){
        ...
        Meeting meeting2 = new Meeting("Follow up on code for time machine", Start_time, End_time, "Remote");
        System.out.println(meeting2.getName());
        System.out.println(meeting2.getDuration());
        System.out.println(meeting2.isComplete());
        meeting2.complete();
        System.out.println(meeting2.isComplete());
